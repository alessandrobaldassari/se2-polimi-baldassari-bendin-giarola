...
%	\addtocounter{page}{-1}
	...
	\subsection{Assumptions and dependencies}
		\begin{itemize}
			...
			\item \textcolor{red}{Taxi drivers are assigned the zone by the system}
		\end{itemize}
...
%	\end{figure}
		...
		\begin{minipage}{\linewidth}
			\vspace*{-0.7cm}
			\makebox[\linewidth]{
				\includegraphics[keepaspectratio=true,scale=0.67]{Pictures/SDRegistration}}
		\end{minipage}
...
%		\vspace*{0.6cm}
		...
		\begin{minipage}{\linewidth}
			\vspace*{-0.35cm}
			\makebox[\linewidth]{
			\includegraphics[keepaspectratio=true,scale=0.6]{Pictures/ClassDiagram}}
		\end{minipage}	
