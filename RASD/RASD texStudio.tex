...
%	\addtocounter{page}{-1}
	...
	\subsubsection{Interfaces to other applications} \mts requires to access to the Internet and to the Google Maps APIs to provide map services.
	...
	\subsection{Assumptions and dependencies}
		\begin{itemize}
			...
			\item Passengers pay only using their valid credit or debit card by linking it to their user profile.
