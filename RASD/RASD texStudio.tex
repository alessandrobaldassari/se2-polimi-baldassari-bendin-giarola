...
%	\subsubsection{Software Interfaces} \textcolor{red}{do we have to pretend to use sql, java ee....???}
	...
	\begin{itemize}
		...
		\item {[}D1{]} The system does not implement a retrieve password mechanism.
	\end{itemize}
	...
	\begin{itemize}
		\item {[}R1{]} The user can customize the reservation, specifying the date and time of the ride, the origin and destination.
	\end{itemize}
	...
	\end{center}
	\begin{center}
		\includegraphics[width=0.9\linewidth]{Pictures/UseCaseRegistration}
	\end{center}
	\pagebreak	
	...
	\begin{center}
		\begin{tabular}{| l | p{9cm} |}\hline
			...
			Output Condition & \begin{enumerate}
									\item \mts verifies the credential of the visitor and if correct shows the home page for the registered user.
