...
%			\vspace*{-0.5cm}
			\makebox[\linewidth]{
				\includegraphics[keepaspectratio=true,scale=0.612]{Pictures/TheWorldAndTheMachine}}
		\end{minipage}	
...
%	\AddToShipoutPictureBG*{\includegraphics[width=\paperwidth,height=\paperheight]{Pictures/ClassDiagram}}
	...
	\subsubsection{Class Diagrams}		
		...
		\begin{minipage}{\linewidth}
			\vspace*{-0.27cm}
			\makebox[\linewidth]{
			\includegraphics[keepaspectratio=true,scale=0.568]{Pictures/ClassDiagram}}
		\end{minipage}	
...
%			\vspace*{-0.35cm}
			\makebox[\linewidth]{
				\includegraphics[keepaspectratio=true,scale=0.66]{Pictures/STMRequestAndRideCreation}}
		\end{minipage}	
...
%			\vspace*{-0.7cm}
			\makebox[\linewidth]{
				\includegraphics[keepaspectratio=true,scale=0.666]{Pictures/STMModifyRequest}}
		\end{minipage}	
...
%			\vspace*{-0.7cm}
			\makebox[\linewidth]{
				\includegraphics[keepaspectratio=true,scale=0.64]{Pictures/STMRequestCancellation}}
		\end{minipage}
		...
		\begin{minipage}{\linewidth}
			%			\vspace*{-0.7cm}
			\makebox[\linewidth]{
				\includegraphics[keepaspectratio=true,scale=0.7]{Pictures/STMAvailability}}
		\end{minipage}	`	
...
%	\subsection{Other Requirements}
	...
	\pagebreak
		...
		\vspace*{-0.7cm}
		\makebox[\linewidth]{
			\includegraphics[keepaspectratio=true,scale=0.83,angle=90,origin=c]{Pictures/metamodel}}
		\end{minipage}	
