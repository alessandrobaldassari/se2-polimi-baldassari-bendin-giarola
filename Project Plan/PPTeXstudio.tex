...
\usepackage{graphicx,subfigure,afterpage,hyperref,xspace,xcolor,caption,soul,geometry,pdfpages,stackengine,eso-pic,fancyhdr,hyphenat,listings,longtable,url,enumitem,fancyvrb,textcomp,eurosym}
	...
	\section{COCOMO II analysis}
		...
		\subsection{Second analysis with automated tool}
			...
			\begin{minipage}{\linewidth}
				%			\vspace*{-0.35cm}
				\makebox[\linewidth]{
					\includegraphics[keepaspectratio=true,scale=0.45]{Pictures/COCOMOoutput.png}}
			\end{minipage}
			\bigskip\\
