...
%				\textbf{ID} & \textbf{Task} & \parbox{3cm}{Effort \\  [Person-Days]} & \textbf{Duration [Days]} & \textbf{Dependencies}		
				...
				\multicolumn{1}{|c|}{T1} & \multicolumn{1}{|c|}{Stakeholders identification} & \multicolumn{1}{|c|}{} & \multicolumn{1}{|c|}{} & \multicolumn{1}{|c|}{}\\\hline
				
				\multicolumn{1}{|c|}{T2} & \multicolumn{1}{|c|}{Actors identification} & \multicolumn{1}{|c|}{} & \multicolumn{1}{|c|}{} & \multicolumn{1}{|c|}{}\\\hline	
				
				\multicolumn{1}{|c|}{T3} & \multicolumn{1}{|c|}{Goals identification} & \multicolumn{1}{|c|}{} & \multicolumn{1}{|c|}{} & \multicolumn{1}{|c|}{}\\\hline							

				\multicolumn{1}{|c|}{T4} & \multicolumn{1}{|c|}{Requirements identification} & \multicolumn{1}{|c|}{} & \multicolumn{1}{|c|}{} & \multicolumn{1}{|c|}{}\\\hline
				
				\multicolumn{1}{|c|}{T5} & \multicolumn{1}{|c|}{Use Case and Scenarios} & \multicolumn{1}{|c|}{} & \multicolumn{1}{|c|}{} & \multicolumn{1}{|c|}{}\\\hline
				
				\multicolumn{1}{|c|}{T7} & \multicolumn{1}{|c|}{Class diagram} & \multicolumn{1}{|c|}{} & \multicolumn{1}{|c|}{} & \multicolumn{1}{|c|}{}\\\hline	
