...
\usepackage{graphicx,subfigure,afterpage,hyperref,xspace,xcolor,caption,soul,geometry,pdfpages,stackengine,eso-pic,fancyhdr,hyphenat,listings}
...
%	\end{minipage}	
	...
	\begin{minipage}{\linewidth}
		%		\vspace*{-0.35cm}
		\makebox[\linewidth]{
			\includegraphics[keepaspectratio=true,scale=0.5]{Pictures/CVRequestManager}}
	\end{minipage}
	RequestHandler:
	\begin{center}
		\begin{tabular}{| l | p{9cm} |}\hline
	...
	\begin{center}
		\begin{tabular}{| l | p{9cm} |}\hline
			...
			Interaction & With all the Passengers, with the RequestWorker component to receive updates from every request and with the DB to stare persistently the data.\\\hline
			Interfaces offered & \begin{itemize}
	...
	\begin{center}
		\begin{tabular}{| l | p{9cm} |}\hline
			...
			Responsibilities & There is an instance of this component for every request generated by the users. It manages the communication related to updates of the request with the Notification manager. It is also connected to the RideManager to start the process of creation of the ride at the decided time\\\hline
			Interaction & With the NotificationManager, with the RideMnager, and with the RequestEngine to store the data about the requests in the DB.\\\hline
			Interfaces offered & \begin{itemize}
	...
	\begin{minipage}{\linewidth}
		%		\vspace*{-0.35cm}
		\makebox[\linewidth]{
			\includegraphics[keepaspectratio=true,scale=0.6]{Pictures/CVNotificationManager}}
	\end{minipage}
