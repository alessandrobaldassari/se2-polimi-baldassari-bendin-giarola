...
%		\vspace*{-0.35cm}
	...
	\begin{center}
		\begin{tabular}{| p{7cm} | p{8cm} |}\hline
			...
			The system has to guarantee a fair management of the queues in each taxi zone. & The QueueManager (inner component of ZoneManager) runs the algorithm described in the previous section (see section~\ref{sec:AlgoQueue}) to guarantee a fair management of the queue, with the mechanism previously agreed.\\\hline
			DA RIEMPIRE & DA RIEMPIRE\\\hline
