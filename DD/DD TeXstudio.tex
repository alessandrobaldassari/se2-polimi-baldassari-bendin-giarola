...
%			\vspace*{-0.35cm}
	...
	\begin{itemize}
		...
		\item User sub-system
			...
			\end{itemize}
	\end{itemize}
	The following schema shows the above-mentioned division of the system.\\
		\begin{minipage}{\linewidth}
			\vspace*{0.35cm}
			\makebox[\linewidth]{
			\includegraphics[keepaspectratio=true,scale=0.83]{Pictures/VisioSystemComponentsColors}}
		\end{minipage}
