...
%		%		\vspace*{-0.35cm}
%		\makebox[\linewidth]{
%			\includegraphics[keepaspectratio=true,scale=0.4]{Pictures/CVRequestManager}}
%	\end{minipage}	
%	
...
%		%		\vspace*{-0.35cm}
%		\makebox[\linewidth]{
%			\includegraphics[keepaspectratio=true,scale=0.4]{Pictures/CVRideManager}}
%	\end{minipage}
%	
...
%		%		\vspace*{-0.35cm}
%		\makebox[\linewidth]{
%			\includegraphics[keepaspectratio=true,scale=0.4]{Pictures/CVNotificationManager}}
%	\end{minipage}
%	
...
%		%		\vspace*{-0.35cm}
%		\makebox[\linewidth]{
%			\includegraphics[keepaspectratio=true,scale=0.4]{Pictures/CVTaxiManager}}
%	\end{minipage}
%	
...
%		%		\vspace*{-0.35cm}
%		\makebox[\linewidth]{
%			\includegraphics[keepaspectratio=true,scale=0.4]{Pictures/CVZoneManager}}
%	\end{minipage}
%	
...
%		%		\vspace*{-0.35cm}
%		\makebox[\linewidth]{
%			\includegraphics[keepaspectratio=true,scale=0.4]{Pictures/CVPaymentManager}}
%	\end{minipage}
